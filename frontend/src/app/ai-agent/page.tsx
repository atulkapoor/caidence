        ...
        return (
            <DashboardLayout>
                <div className="max-w-5xl mx-auto space-y-6">
                    <StrategyResult strategy={result.strategy} projectId={result.project_id} />
                </div>
            </DashboardLayout>
        );
    }
        ...
        <DashboardLayout>
            <div className="max-w-4xl mx-auto">
                <div className="mb-8 text-center">
                    <h1 className="text-3xl font-black text-slate-900 mb-2">Configure Your AI Agent</h1>
                    <p className="text-slate-500">Set up your autonomous marketing campaign parameters</p>
                </div>
