                    ...
                    {activeTab === "overview" ? (
                        <div className="space-y-8 animate-in fade-in duration-500">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                {[
                                    { title: "Total Reach", value: "1.2M", change: "+12%", icon: Users, color: "text-blue-500" },
                                    { title: "Engagement Rate", value: "4.8%", change: "+0.5%", icon: MousePointer, color: "text-purple-500" },
                                    { title: "Conversions", value: "842", change: "+18%", icon: TrendingUp, color: "text-emerald-500" },
                                    { title: "Campaign ROI", value: "3.2x", change: "+5%", icon: BarChart3, color: "text-orange-500" },
                                ].map((stat, i) => (
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                ...
                                <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm flex flex-col">
                                    ...
                                    <div className="mt-8 space-y-4 flex-1">
                                        {[
                                            { name: 'Mobile', value: '45%', color: 'bg-purple-500' },
                                            { name: 'Desktop', value: '35%', color: 'bg-indigo-500' },
                                            { name: 'Tablet', value: '20%', color: 'bg-emerald-500' },
                                        ].map((item, i) => (
